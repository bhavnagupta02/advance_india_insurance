  ...
  <!-- <div class="breadcum-Strip">
    <div class="col-sm-2 sidenav leftSideNav" id="sideBreadCrubmFields">
      <ul id="sideBreadcrumbList">
        ...
        <li class="side_nav sidenav_icon-active"><a href="<?php echo base_url('owner-details');?>" class="currentPage"><span class="img-type"></span> Owner Details</a></li>
        <li class="side_nav sidenav_icon-inactive"><a href="<?php echo base_url('personal-details');?>" ><span class="img-type"></span>Personal Details</a></li>
      ...
      <div id="wizard" role="application" class="wizard clearfix">
        <div class="content clearfix">
          <section class="tabSec tabSecnew body current">
            <div class="row">
              <div class="col-md-12">
                <h2 class="mrg-L20 ownerHeadMob">Owner Details</h2>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <section class="contentSection mainFilter sec_bankList">
                  <div class="card offlineCard">
                    <form method="post">
                      <div class="row mrg-T20 disableCheck">
                        <div class="col-md-12 config-chk"> <span class="">
                          <input type="checkbox" name="is_company_vehicle" id="is_company_vehicle" value="1" class="trigger">
                          <label for="is_company_vehicle" class="car-company-name"><span class="dt-yes"></span> This <?php if(isset($exp_policy_data['ins_type'])){echo $exp_policy_data['ins_type'];}?> is in the name of a company</label>
                          </span> </div>
                      </div>
                      <div class="row mrg-T20 companyFields" style="display: none;">
                        <div class="col-md-6 form-group companyFields">
                          <label for="" class="liteLabel">Company Name <span class="text-danger">*</span></label>
                          <input class="form-control filterInput" type="text" placeholder="Company Name" name="company_name" value="" maxlength="100" >
                        </div>
                        <div class="col-md-6 form-group companyFields">
                          <label for="" class="liteLabel">GSTIN</label>
                          <input class="form-control filterInput" type="text" placeholder="GSTIN" name="company_gstin" id="company_gstin" value="" minlength="15" maxlength="15">
                        </div>
                      </div>
                      <div class="row mrg-T20 nonCompanyFields">
                        <div class="col-md-6 form-group nonCompanyFields">
                          <label for="" class="liteLabel">First Name <span class="text-danger">*</span></label>
                          <input class="form-control filterInput" placeholder="First Name" name="first_name" value="" maxlength="50" minlength="1" required="">
                        </div>
                        <div class="col-md-6 form-group nonCompanyFields">
                          <label for="" class="liteLabel">Last Name</label>
                          <input class="form-control filterInput" placeholder="Last Name" name="last_name" value="" maxlength="50">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 form-group">
                          <label for="" class="liteLabel">Email <span class="text-danger">*</span></label>
                          <input class="form-control filterInput" type="email" placeholder="Email ID" name="email" value="" required="" >
                          <span class="validation"></span>
                        </div>
                        <div class="col-md-6 form-group">
                          <label for="" class="liteLabel">Phone <span class="text-danger">*</span></label>
                          <input type="tel" class="form-control filterInput onlyNumbers" minlength="10" maxlength="10" placeholder="Phone Number" name="phone_no" id="phone_no" value="" required="" >
                        </div>
                      </div>
                      <!-- <div class="row ">
                        <div class="col-md-6 form-group" id="pan_card_div">
                          <label for="" class="liteLabel">Pan Card <span class="text-danger"></span></label>
                          <input class="form-control filterInput" type="text" placeholder="Pan Card" maxlength="10" id="pan_card" name="pan_card" value="">
                        </div>
                        <div class="col-md-6 form-group" id="aadhar_card_div">
                          <label for="" class="liteLabel">Aadhar Number <span class="text-danger"></span></label>
                          <input class="form-control filterInput onlyNumbers" type="tel" placeholder="Aadhar Card" maxlength="12" id="aadhar_number" name="aadhar_number" value="">
                        </div>
                      </div> -->
                      <div class="row">
                        <div class="col-md-12">
                          <h5><strong>Address as on RC</strong></h5>
                        </div>
                      </div>
                      <div class="row" id="fullAddressErrorMsg"></div>
                      <div class="row mrg-T20">
                        <div class="col-md-6 form-group">
                          <label for="" class="liteLabel">Address Line 1 (Don't enter father name in address) <span class="text-danger">*</span></label>
                          <textarea class="form-control filterInput" data-limit=70 rows="1" placeholder="Address Line 1" name="primary_address_line1" id="primary_address_1" maxlength="" required=""></textarea>
                          <span class="countdown"></span>
                        </div>
                      <div class="col-md-6 form-group">
                          <label for="" class="liteLabel">Pincode <span class="text-danger">*</span></label>
                          <input class="form-control filterInput" type="tel" placeholder="Pin Code" name="primary_pin_code" id="pin_code" minlength="6" maxlength="6" value="">
                        </div>
                        <!--<div class="col-md-6 form-group">
                          <label for="" class="liteLabel">Address Line 2</label>
                          <textarea class="form-control filterInput" rows="1" placeholder="Address Line 2" name="primary_address_line2" id="primary_address_2" maxlength=""></textarea>
                        </div>-->
                      </div>
                      <!-- <div class="row ">
                        <div class="col-md-12 form-group">
                          <label for="" class="liteLabel">Address Line 3</label>
                          <textarea class="form-control filterInput" rows="1" placeholder="Address Line 3" name="primary_address_3" id="primary_address_3" maxlength=""></textarea>
                        </div>
                      </div> -->
                      <div class="row ">
                        ...
                        <div class="col-md-6 mobSumo">
                          <div class="form-group">
                            <label for="" class="liteLabel">State <span class="text-danger">*</span></label>
                            <select name="primary_state" id="primary_state" data-url="<?php echo base_url('home/fetch_city'); ?>" title="Please select state" class="search-box " onchange="//getCity(this.id,'corr_city');" aria-required="true" tabindex="-1">
                                  ...
                                  <option value="Uttarakhand">Uttaranchal/Uttarakhand</option>
                        ...
                        <div class="col-md-6 mobSumo">
                          <div class="form-group">
                            <label for="" class="liteLabel">City <span class="text-danger">*</span></label>
                              <!-- <select name="city" id="city" title="Please select city" class="search-box" required="" aria-required="true" tabindex="-1">
                                <option value=""> --select city-- </option>
                              </select> -->
                              <select name="primary_city" id="city" title="Please select city" class="search-box" required="" aria-required="true" tabindex="-1">
                      ...
                      <div class="row ">
                        <div class="col-md-12 config-chk"> <span class="">
                          <input type="checkbox" name="is_corr_address_same" id="is_corr_address_same" class="trigger" checked="" value="1" data-rel="">
                          <label for="is_corr_address_same"><span class="dt-yes"></span> Is correspondence address same as registration address?</label>
                          </span> </div>
                      </div>
                      <div id="registration_fields" class="correspondence_add" style="display: none;">
                        <div class="row">
                          <div class="col-md-12">
                            <h5><strong>Correspondence Address</strong></h5>
                          </div>
                        </div>
                        <div class="row mrg-T20" id="fullCorrsAddressErrorMsg"></div>
                        <div class="row mrg-T20">
                          <div class="col-md-6 form-group">
                            <label for="" class="liteLabel">Correspondence Address Line 1 <span class="text-danger">*</span></label>
                            <textarea class="form-control filterInput" rows="1" placeholder="Address Line 1" name="corrs_address_line1" id="corrs_address_1" maxlength="" ></textarea>
                          </div>
                          <div class="col-md-6 form-group">
                            <label for="" class="liteLabel">Correspondence Address Line 2</label>
                            <textarea class="form-control filterInput" rows="1" placeholder="Address Line 2" name="corrs_address_line2" id="corrs_address_2" maxlength=""></textarea>
                          </div>
                        </div>
                        <!-- <div class="row ">
                          <div class="col-md-12 form-group">
                            <label for="" class="liteLabel">Correspondence Address Line 3</label>
                            <textarea class="form-control filterInput" rows="1" placeholder="Address Line 3" name="corrs_address_3" id="corrs_address_3" maxlength=""></textarea>
                          </div>
                        </div> -->
                        <div class="row ">
                          <div class="col-md-6 form-group">
                            <label for="" class="liteLabel">Pincode <span class="text-danger">*</span></label>
                            <input class="form-control filterInput onlyNumbers" type="text" placeholder="Pin Code" name="corr_pin_code" id="corr_pin_code" minlength="6" maxlength="6" >
                          </div>
                          <div class="col-md-6 mobSumo">
                            <div class="form-group">
                              <label for="" class="liteLabel">State <span class="text-danger">*</span></label>
                                <select name="corr_state" id="corr_state" data-url="<?php echo base_url('home/fetch_city'); ?>" title="Please select state" class="search-box " onchange="//getCity(this.id,'corr_city');" tabindex="-1">
                                  <option value=""> --select state-- </option>
                                  <option value="Andaman and Nicobar">Andaman &amp; Nicobar</option>
                                  <option value="Andhra Pradesh">Andhra Pradesh</option>
                                  <option value="Arunachal Pradesh">Arunachal Pradesh</option>
                        ...
                        <div class="row">
                          <div class="col-md-6 mobSumo">
                            <div class="form-group">
                              <label for="" class="liteLabel">City <span class="text-danger">*</span></label>
                                <select name="corr_city" id="corr_city" title="Please select city" class="search-box" tabindex="-1">
                                  <option class="" value="">Select City </option>
                                  <!-- <option value="Port Blair">Port Blair</option>
                                  <option value="Adilabad">Adilabad</option>
                                  <option value="Anantapur">Anantapur</option>
