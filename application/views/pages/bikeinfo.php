  <div class="sec_tab sectionHeader2 carInfo new-section">
    <div class="container">
      <div class="subHeading"> <a href="<?php echo base_url('user-dashboard');?>" ><img src="<?php echo base_url('assets/images/ic_car.svg');?>" class="imgIc">Private  Car</a> <a class="active" href="<?php echo base_url('bike-info');?>"><img src="<?php echo base_url('assets/images/ic_bike.svg');?>" class="imgIc">Two Wheeler Insurance</a>
      <!-- <a href="pcv.html"><img src="images/ic_pcv.svg" class="imgIc">PCV</a><a href="gcv.html"><img src="images/gcv.svg" class="imgIc">GCV</a> --> </div>
    </div>
  </div>
  <!-- Tab Section -->
  ...
  <div id="" class="container ">
    <div class="row">
      <div class="col-md-12">
        <h3 class="mainHeading mainHeading_2" style="display:inline-block;margin-bottom:21px;">Multiple Bike Insurance</h3>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="expPolicy">
                <form role="form" method="post">
                  <div class="row">
                    <input type="hidden" name="ins_type" value="bike">
                    ...
                    <div class="col-md-6 mobSumo">
                      <div class="form-group">
                        <label for="" class="liteLabel">Make / Model</label>
                          <select class="search-box" name="make_model" id="make_model" tabindex="-1" required data-url="<?php echo base_url('home/fetch_varints_basedon_model');?>" data-vehicle-type="two_wheeler" placeholder="Search Make / Models....">
                            <option value="" selected="selected" disabled="disabled">Select Make/Model</option>
                            <?php foreach($bike_models_data as $val){?>
                            <option value="<?php if(isset($val['model_name'])){echo $val['model_name'];} ?>"><?php if(isset($val['model_name'])){echo ucwords($val['model_name']);} ?></option>
                            <?php }?>
                          </select>
                    ...
                    <div class="col-md-6 mobSumo">
                      <div class="form-group">
                        <label for="" class="liteLabel">Variant</label>
                          <select class="search-box " name="variant" id="variant" required data-url="<?php echo base_url('home/fetch_cc_basedon_varints');?>" data-vehicle-type="two_wheeler">
                            <option value="" selected="selected" disabled="disabled">Select Variant</option>
                            <!-- <?php foreach($bike_variants_data as $val){?>
                      ...
                      <div class="form-group">
                        <label for="" class="liteLabel">Cube Capacity</label>
                          <select class="search-box" id="cubeCapacity" name="fuel_capacity_price" required>
                            ...
                            <!--<option value="75cc to 150cc-887">75cc to 150cc</option>
                            <option value="151cc to 350cc-1407">151cc to 350cc</option>
                            <option value="Above 351cc-2741">Above 351cc</option> -->
                          </select>
