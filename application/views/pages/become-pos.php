  ...
  <div class="container_space padding-mobile become-section">
  <div id="band" class="container ">
    <form method="post" enctype="multipart/form-data">
      ...
      <section class="contentSection mainFilter marg contentSection mainFilter card cstm cardMob padAll-15 become-inner">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6 form-group ">
            ...
            <div class="col-md-6 form-group ">
                <label for="" class="liteLabel">Password<span class="required">*</span></label>
                <input class="form-control filterInput" size="16" type="Password" value="" name="password" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
            </div>
          
        <div class="col-md-6 form-group">            <label for="" class="liteLabel">Mobile No.<span class="required">*</span></label>            <input class="form-control filterInput" maxlength="10" type="text" value="" name="mobile_number" required>          </div>
          <div class="col-md-6 form-group ">
        ...
        <div class="col-md-6 form-group">            <label for="" class="liteLabel">Aadhar No.<span class="required">*</span></label>            <input class="form-control filterInput" maxlength="12" type="text" value="" name="aadhar_number" required>          </div>
          <div class="col-md-6 form-group ">
      ...
      <section class="contentSection mainFilter bankSection card cstm cardMob padAll-15 become-inner">
        <div class="row ">
          <div class="col-md-6 mrg-B10">
      ...
      <section class="contentSection mainFilter documentSection card cstm cardMob padAll-15 become-inner">
        <div class="row ">
          <div class="col-md-6 mrg-B10">
      ...
      <div class="row">
        <div class="textcenter">
          <div class="col-md-12 mrg-B10 validateLead-become"> <!-- <a href="#" class="btn btn-default filterBtn getQuotes btn-addUser-or validateLead btnContinue">Continue</a> --> <button type="submit" class="btn btn-default filterBtn getQuotes btn-addUser-or validateLead btnContinue">Continue</button> </div>
        </div>
      </div>
    </form>
  </div>
