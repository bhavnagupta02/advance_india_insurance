...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php //echo base_url('assets/admin/icon/ion-icon/css/ionicons.min.css'); ?>"> -->
    <!-- Style.css -->
    
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/css/style.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/css/custom.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/data-table/css/dataTables.bootstrap4.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/data-table/css/buttons.dataTables.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/data-table/css/responsive.bootstrap4.min.css'); ?>">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="<?php echo base_url('admin/dashboard'); ?>" class="logo-cnt">
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <!--<li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="<?php echo base_url('assets/admin/images/avatar-4.png'); ?>" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src=" <?php echo base_url('assets/admin/images/avatar-3.jpg'); ?>" alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<?php echo base_url('assets/admin/images/avatar-4.png'); ?>" class="img-radius" alt="User-Profile-Image">
                                        <span><?php if(isset($this->admin_data)){ echo $this->admin_data['name']; }?></span>
                        ...
                        <div class="user-box">
                            ...
                            <div class="main-friend-list">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src=" <?php echo base_url('assets/images/avatar-4.png'); ?>" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
