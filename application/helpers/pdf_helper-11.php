...
function pdf_template($exp_policy_data,$site_url)
{
 ...
 <tr>
  <td width="80" ><span style="line-height:16px">&nbsp;</span><br /><img style="width:70px;vertical-align: middle;" src="'.$site_url.'assets/images/logo.jpg" alt=""  align="middle"></td>
...
<table  class="section-Advance-Name" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
	 ...
	 <td width="170" style="color:#000;">9811437643</td>
...
<table class="section-Corporate" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td width="380" style="font-size: 10px;line-height:20px;font-weight:bold">Acko General Insurance Ltd.</td>
  ...
  $content .= '<table class="first"  cellpadding="0" cellspacing="0" border="0">
<tr>
  <td width="80" ><span style="line-height:18px">&nbsp;</span><br /><img style="width:70px;vertical-align: middle;" src="'.$site_url.'assets/images/logo.jpg" alt=""  align="middle"></td>
  <td  width="400" style="font-size: 13px;color: #000;font-weight: bold;line-height:14px;font-family:dejavusans;"><span ><br />LIABILITY ONLY POLICY - PRIVATE '.strtoupper($exp_policy_data['ins_type']).'</span><br />
...
<tr >
  <td width="220" style="line-height:14px;font-weight:bold;font-size:10px;border-bottom:2px solid #000;color:#000;">POLICY DETAILS</td>
  <td width="30">&nbsp;</td>
  <td width="220" style="line-height:14px;font-weight:bold;font-size:10px;border-bottom:2px solid #000;color:#000;">VEHICLE DETAILS</td>
...
<tr>
  ...
  <td width="110"  rowspan="2" style="color:#000;line-height:10px;text-transform: lowercase;"><strong>'.$exp_policy_data['primary_address_line1'].", ".$exp_policy_data['primary_address_line2'].", ".$exp_policy_data['primary_city'].", ".$exp_policy_data['primary_state'].'</strong></td>
  <td width="30">&nbsp;</td>
...
$content .= '<table class="first"  cellpadding="5" cellspacing="5" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .= '
<style>
table.section-pre-details td {
    font-family:dejavusans;
...
<tr>
  ...
  <td width="60" style="font-family:dejavusans; font-weight:bold;">'.$financial_company.'</td>
</tr>
</table>';
$content .= '<table class="first"  cellpadding="1" cellspacing="1" border="0"><tr><td>&nbsp;</td></tr></table>';
...
<tr>
  <td width="120" bgcolor="#dddddd" style="line-height:20px; border:none;"> Name</td>
  <td width="70" bgcolor="#dddddd" style="line-height:20px; border:none;"> Code </td>
  <td width="90" bgcolor="#dddddd" style="line-height:20px; border:none;"> Contact </td>
  <td width="100" bgcolor="#dddddd" style="line-height:20px; border:none;"> Email </td>
  <td width="160" bgcolor="#dddddd" style="line-height:20px; border:none;"> Address </td>
</tr>
<tr>
  ...
  <td width="70"><span style="line-height:4px">&nbsp;</span> 131362 <span style="line-height:4px">&nbsp;</span></td>
  <td width="90"><span style="line-height:4px">&nbsp;</span> +917551196988 <span style="line-height:4px">&nbsp;</span></td>
  <td width="100"><span style="line-height:4px">&nbsp;</span> <a href="#">support@info.cvom</a> <span style="line-height:4px">&nbsp;</span></td>
...
<tr>
  <td width="180" bgcolor="#dddddd" style="border:none;" > &nbsp; POS Name </td>
  <td width="180" bgcolor="#dddddd" style="border:none;"> &nbsp; POS Contact </td>
  <td width="180" bgcolor="#dddddd" style="border:none;"> &nbsp; POS ID NO </td>
</tr>
</table>';
$content .= '<table class="first"  cellpadding="32" cellspacing="32" width="100%" border="0"><tr><td>&nbsp;</td></tr></table>';
...
<table class="section-Corporate" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tr>
    <td width="300" style="font-size: 10px;line-height:20px;font-weight:bold">Acko General Insurance Ltd.</td>
    <td  rowspan="8"  align="center" width="80"><br /> <img src="'.$site_url.'assets/images/acko-badge.jpg" alt="" style="text-align:center;width:70px"></td>
...
<table class="section-general" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tr>
    <td width="80"><img  style="width:70px;vertical-align: middle;" src="'.$site_url.'assets/images/logo.jpg" alt=""> </td>
    <td  width="330" style="font-size: 15px;color: #000;font-weight: bold;line-height:30px; font-family:dejavusans;"> PREMIUM RECEIPT </td>
  </tr>
</table>';
...
<table class="section-general" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tr>
    <td  width="540" style="font-size:9px;color: #000;font-weight: normal;line-height:16px;font-family:dejavusans;">Receieved with thanks from '.$full_name.' a sum of <span style="font-family:dejavusans;">&#8377;</span> '.$exp_policy_data['total_amount'].' towards premium on '.strtoupper($exp_policy_data['ins_type']).' Insurance Policy</td>
  </tr>
</table>'; 
$content .= '<table class="first"  cellpadding="2" cellspacing="2" width="100%" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .= '
...
<tr >
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px; line-height: 16px;font-family:dejavusans;color:#000;">INSURED DETAILS</td>
  <td width="30">&nbsp;</td>
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px;line-height: 16px;font-family:dejavusans;color:#000;">INTERMEDIARY DETAILS</td>
</tr>
<tr>
...
<tr>
  ...
  <td width="155" style="color:#000;"><strong>'.$exp_policy_data['primary_address_line1'].", ".$exp_policy_data['primary_address_line2'].", ".$exp_policy_data['primary_city'].", ".$exp_policy_data['primary_state'].' </strong> </td>
  <td width="30" >&nbsp;</td>
  <td width="60">Code:</td>
...
<tr>
 ...
 $content .= '<style>
    ...
    </style><table class="section-terms" cellpadding="0" cellspacing="0"border="0">
<tr>
  <td width="540">TERMS & CONDITIONS</td>
</tr>
</table>';
$content .= '<style>
...
<table class="section-receipt"  cellpadding="0" cellspacing="0" width="100%" border="0">
<tr>
  <td width="540" style="line-height:3px"></td>
  </tr>
<tr>
  <td width="540">Issuance of this receipt does not amount to acceptance of the risk by Acko General Insurance Limited. The insurance cover for the risk shall be as per the terms and conditions of the Insurance Policy if and when issued. Cheque/DD/PO receipt is valid subject to the realization of the instrument.</td>
</tr>
<tr>
  <td width="540" style="line-height:3px"></td>
  </tr>
</table>';
$content .= '<table class="first"  cellpadding="60" cellspacing="60" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .='<style>
.section-Corporate td{
    text-align:left;
    padding:15px;
...
<table class="section-general" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tr>
    <td width="80"><img  style="width:70px;vertical-align: middle;" src="'.$site_url.'assets/images/logo.jpg" alt=""> </td>
    <td  width="310" style="font-size: 15px;color: #000;font-weight: bold;line-height:30px;font-family:dejavusans;"> PROPOSAL FORM</td>
  </tr>
</table>';
...
$content .= '<table class="first"  cellpadding="1" cellspacing="2" width="100%" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .= '
<style>
...
<tr >
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px; line-height: 20px;font-family:dejavusans;color:#000;">POLICY DETAILS</td>
  <td width="30">&nbsp;</td>
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px;line-height: 20px;font-family:dejavusans;color:#000;">BIKE DETAILS</td>
</tr>
<tr>
...
<tr >
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px; line-height:20px;    color:#000">BIKE OWNER DETAILS</td>
  <td width="30">&nbsp;</td>
  <td width="255" style="border-bottom:2px solid #000; font-weight:bold; font-size:10px;line-height: 20px;    color:#000">NOMINEE DETAILS</td>
</tr>
<tr>
  <td width="125" style="line-height:4px;">&nbsp;</td>
  <td width="130" style="line-height:4px;">&nbsp;</td>
