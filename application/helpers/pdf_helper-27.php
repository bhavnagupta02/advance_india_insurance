...
<tr>
  ...
  <td style="color:#000;" width="250">'.$full_name.'</td>
  <td width="20">&nbsp;</td>
...
<tr>
  ...
  <td style="color:#000;" width="250">'.$exp_policy_data['primary_pin_code'].' </td>
  <td width="20">&nbsp;</td>
...
<tr>
  ...
  <td style="color:#000;" width="250">'.$exp_policy_data['company_gstin'].'</td>
  <td width="20">&nbsp;</td>
...
<tr>
  ...
  <td style="color:#000;" width="250">'.$payment_date.' to '.$policy_exp_date.' </td>
  <td width="20">&nbsp;</td>
  <td width="110">Engine No: </td>
  <td style="color:#000;" width="220">'.strtoupper($exp_policy_data['engine_no']).'</td>
</tr>
<tr>
  <td  width="110">Policy Issuance Date:</td>
  <td style="color:#000;" width="250">'.$insurance_date.'</td>
  <td width="20">&nbsp;</td>
  <td width="110">Chassis No:</td>
  <td style="color:#000;" width="220">'.strtoupper($exp_policy_data['chassis_no']).'</td>
</tr>
<tr>
<td width="110">Policy Number: </td>
<td style="color:#000;" width="250">'.$policy_no.'</td>
</tr>
...
<tr >
  ...
  <td rowspan="6" width="100" ><img style="width:70px;" align="right" src="'.$qrcode_img.'" alt=""></td>
</tr>
<tr>
...
$content .= '<table class="first"  cellpadding="170" cellspacing="170" width="100%" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .='<style>
.section-Corporate td{
    text-align:left;
    padding:15px;
...
<tr >
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px; line-height: 30px;font-family: helvetica ;">INSURED DETAILS</td>
  <td width="20">&nbsp;</td>
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px;line-height: 30px;font-family: helvetica ;">INTERMEDIARY DETAILS</td>
</tr>
<tr>
...
$content .= '<table class="first"  cellpadding="105" cellspacing="105" width="100%" border="0"><tr><td>&nbsp;</td></tr></table>';
$content .='<style>
.section-Corporate td{
    text-align:left;
    padding:15px;
...
<tr >
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px; line-height: 30px;font-family: helvetica ;">POLICY DETAILS</td>
  <td width="20">&nbsp;</td>
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px;line-height: 30px;font-family: helvetica ;">BIKE DETAILS</td>
</tr>
<tr>
  <td width="150" style="line-height:4px;">&nbsp;</td>
  <td width="180" style="line-height:4px;">&nbsp;</td>
  <td width="20" style="line-height:4px;">&nbsp;</td>
  <td width="150" style="line-height:4px;">&nbsp;</td>
  <td width="180" style="line-height:4px;">&nbsp;</td>
</tr>
<tr>
  ...
  <td width="180" style="color:#000;"><strong>'.$policy_no.'</strong></td>
  <td width="20">&nbsp;</td>
  <td width="150">Bike Number : </td>
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['vehicle_registration_no'].'</strong></td>
</tr>
<tr>
<td width="150">Period of Insurance: </td>
<td width="180" style="color:#000;"><strong>'.$payment_date.' to '.$policy_exp_date.' </strong></td>
<td width="20">&nbsp;</td>
<td width="150">Make/Model: </td>
<td width="180" style="color:#000;"><strong>'.$exp_policy_data['make_model'].' </strong></td>
</tr>
<tr>
<td width="150">Policy Issuance Date: </td>
<td width="180" style="color:#000;"><strong>'.$insurance_date.'</strong> </td>
<td width="20">&nbsp;</td>
<td width="150"> Fuel Type: </td>
<td width="180" style="color:#000;"><strong>'.$exp_policy_data['fuel_type'].' </strong></td>
</tr>
<tr>
<td width="150">&nbsp;</td>
<td width="180" style="color:#000;">&nbsp;</td>
<td width="20">&nbsp;</td>
<td width="150">Registration Year: </td>
<td width="180" style="color:#000;"><strong>'.$exp_policy_data['registration_year'].'</strong> </td>
</tr>
<tr>
<td width="150"> &nbsp;</td>
<td width="180" style="color:#000;">&nbsp;</td>
<td width="20">&nbsp;</td>
<td width="150">Manufacturing Year: </td>
<td width="180" style="color:#000;"><strong>'.$mfg_date.' </strong> </td>
</tr>
<tr>
<td width="150"> &nbsp;</td>
<td width="180" style="color:#000;">&nbsp;</td>
<td width="20">&nbsp;</td>
<td width="150">Insured Declared Value (IDV): </td>
<td width="180" style="color:#000;"><strong>N/A </strong> </td> 
</tr>
<tr>
<td width="150"> &nbsp;</td>
<td width="180" style="color:#000;">&nbsp;</td>
<td width="20">&nbsp;</td>
<td width="150">Accessories (IDV): </td>
<td width="180" style="color:#000;"><strong>0 </strong> </td> 
</tr>
</table>';
...
<tr >
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px; line-height: 30px;">BIKE OWNER DETAILS</td>
  <td width="20">&nbsp;</td>
  <td width="330" style="border-bottom:2px solid #000; font-weight:bold; font-size:13px;line-height: 30px;">NOMINEE DETAILS</td>
</tr>
<tr>
  <td width="150" style="line-height:4px;">&nbsp;</td>
  <td width="180" style="line-height:4px;">&nbsp;</td>
...
<tr>
  ...
  <td width="180" style="color:#000;"><strong>'.$full_name.'</strong> </td>
  <td width="20">&nbsp;</td>
  <td width="150">Name: </td>
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['nominee_name'].' </strong> </td>
</tr>
<tr>
  <td width="150">Email Address:  </td>
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['email'].'</strong> </td>
  <td width="20">&nbsp;</td>
  <td width="150">Relationship with Insured: </td>
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['nominee_relation'].' </strong> </td>
</tr>
<tr>
  <td width="150">Mobile Number: </td>
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['phone_no'].' </strong> </td>
  <td width="20">&nbsp;</td>
  <td width="150"> &nbsp; </td>
  <td width="180" style="color:#000;">&nbsp;</td>
</tr>
<tr>
  ...
  <td width="180" style="color:#000;"><strong>'.$exp_policy_data['primary_pin_code'].' </strong></td>
  <td width="20">&nbsp;</td>
  <td width="150">&nbsp;</td>
  <td width="180" style="color:#000;">&nbsp;</td>
</tr>
