...
function pdf_template($exp_policy_data,$site_url)
{
 ...
 <tr>
  <td  width="100"><img style="width:80px; margin:10px 0px 0px;" src="'.$site_url.'assets/images/logo.jpg" alt=""></td>
  <td  width="300" style="font-size: 15px;color: #000;font-weight: bold;line-height:18px;"><span >LIABILITY ONLY POLICY - PRIVATE '.strtoupper($exp_policy_data['ins_type']).'</span>
  <span style="font-family:Arial, Helvetica, sans-serif;font-size: 11px;color: #8c8c8c;font-weight: normal;line-height:16px;">Certificate of Insurance cum Policy Schedule</span></td>
   
 </tr>
</table>';
$content .= '<table class="first"  cellpadding="2" cellspacing="2" border="0px"><tr><td>&nbsp;</td></tr></table>';
$content .= '
<Style>
.section-vehicle td{
font-size: 10px;
...
</style><table width="800" class="section-vehicle" cellpadding="0" cellspacing="0" width="100%" border="0">
<tr >
 <td width="330" style="font-weight:bold; line-height: 24px;padding-bottom: 4px;font-size:13px;border-bottom:2px solid #000">POLICY DETAILS</td>
 <td width="20">&nbsp;</td>
 <td width="330" style="position:relative; right:0px float:right;font-weight:bold; font-family: Arial;line-height: 24px;font-size:13px;border-bottom:2px solid #000">VEHICLE DETAILS</td>
...
<tr>
  ...
  <td style="color:#000;" width="220">'.$full_name.'</td>
  <td width="20">&nbsp;</td>
  <td width="110">Registration Number:</td>
  <td style="color:#000;" width="220">'.$exp_policy_data['vehicle_registration_no'].'</td>
</tr>
<tr>
  <td width="110">Pincode: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['primary_pin_code'].' </td>
  <td width="20">&nbsp;</td>
  <td width="110">Make/Model:</td>
  <td style="color:#000;" width="220">'.$exp_policy_data['make_model'].' </td>
</tr>
<tr>
  <td width="110">Company Name: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['company_name'].' </td>
  <td width="20">&nbsp;</td>
  <td width="110">Fuel Type: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['fuel_type'].' </td>
</tr>
<tr>
  <td width="110">GSTIN: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['company_gstin'].'</td>
  <td width="20">&nbsp;</td>
  <td  width="110">Purchase Year: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['registration_year'].' </td>
</tr>
<tr>
  <td width="110">Period of Insurance: </td>
  <td style="color:#000;" width="220">'.$payment_date.' to '.$policy_exp_date.' </td>
  <td width="20">&nbsp;</td>
  <td width="110">Engine No: </td>
  <td style="color:#000;" width="220">'.$exp_policy_data['engine_no'].'</td>
</tr>
<tr>
  <td  width="110">Policy Insurance Date:</td>
  <td style="color:#000;" width="220">'.$insurance_date.'</td>
  <td width="20">&nbsp;</td>
  <td width="110">Chassis No:</td>
  <td style="color:#000;" width="220">'.$exp_policy_data['chassis_no'].'</td>
</tr>
<tr>
<td width="110">Policy Number: </td>
<td style="color:#000;" width="220">'.$policy_no.'</td>
</tr>
...
<tr>
  <td width="680">PREMIUM DETAILS (₹)</td>
</tr>
</table>';
...
<tr>
  <td width="680" bgcolor="#f5f5f5" style="text-align:left;border:none !important; color:#000;"> &nbsp; <strong>Premium Breakup</strong></td>
</tr>
<tr>
...
$content .= '<style>
    ...
    </style><table width="530" class="section-Geographical" cellpadding="0" cellspacing="0" border="0">
<tr>
  <td width="130">Geographical Area:</td>
  <td width="130" style="color:#000;">India</td>
</tr>
</table>';
$content .= '<table class="first"  cellpadding="20" cellspacing="20" border="0"><tr><td style="line-height:10px">&nbsp;</td></tr></table>';
$content .='<style>
...
<tr>
  <td width="680" style="font-size: 9px;" ><strong>Please Note:</strong>In case of a claim event arising within 30 days from the start of this Policy&cedil; the Insured is required to submit a copy of his Previous Insurance Policy.</td>
</tr>
</table>
';
$content .= '<table class="first"  cellpadding="0" cellspacing="0" border="0"><tr><td style="line-height:20px">&nbsp;</td></tr></table>';
$content .='<style>
    table.section-note td {
        text-align:left;
        font-family: Arial;
...
<table class="section-general" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td width="520"><span style="font-weight:bold;font-size: 14px;line-height:24px;">Acko General Insurance Ltd.</span><br />
      <span style="line-height: 16px;font-size: 10px;">Unit No. 301, 3rd Floor, E Wing, Lotus Corporate Park, Off Western Express Highway,</span><br />
      <span style="line-height: 16px;font-size: 10px;">Goregaon (E), Mumbai – 400063.</span><br />
      <span style="line-height: 16px;font-size: 10px;">Email: hello@acko.com | Phone: 1800 266 2256 | www.acko.com </span><br />
      <span style="line-height: 16px;font-size: 10px;">CIN : U66000MH2016PLC287385 | IRDAI Reg No. 157 | UIN: IRDAN157P0002V01201718 </span></td>
 ...
 <tr>
  ...
  <td width="400"><span style="font-size: 20px;color: #000;font-weight:bold; line-height:20px;">LIABILITY ONLY POLICY - PRIVATE '.strtoupper($exp_policy_data['ins_type']).'</span>
...
<tr>
  <td  width="215" style="font-size: 10px;color:#000;font-family: Arial;font-weight:normal;line-height:16px;">Policy Number: <span>'.$policy_no.'</span></td>
</tr>
</table>';
...
<tr>
  <td width="265">Policy Number :<span> '.$policy_no.' </span></td>
  <td width="265"> &nbsp;</td>
</tr>
</table>';
